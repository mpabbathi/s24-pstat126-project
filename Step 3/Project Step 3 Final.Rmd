...
```{r,fig.cap="Inluenfial Points Analysis"}
...
From the plot and the best fit lines (Fig.5), the lines only change a little for the model with or without the influential points, so we shouldn't be concerned about those point affecting the results.
